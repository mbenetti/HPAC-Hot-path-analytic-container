...
This container run in a 2 core x86 architecture with at least 2 GB of RAM. The idea behind is a solution for analytics of real time sensor data to use in IoT scenarios.
